...
namespace Northwind.Data
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncomes(string companyName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncomes", companyNameParameter, startDateParameter, endDateParameter);
        }
    }
}
